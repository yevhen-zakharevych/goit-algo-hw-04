...
if __name__ == '__main__':
    ...
    print(f"{'| Algorithm': <20} | {'Time 100': <20} | {'Time 1k': <20} | {'Time 10k': <20}")
    print(f"{'-' * 20} | {'-' * 20} | {'-' * 20} | {'-' * 20}")
    ...
    print(f"{'| Sort': <20} | {time_small_sort:<20.5f} | {time_medium_sort:<20.5f} | {time_large_sort:<20.5f}")
    print(f"{'| Sorted': <20} | {time_small_sorted:<20.5f} | {time_medium_sorted:<20.5f} | {time_large_sorted:<20.5f}")
